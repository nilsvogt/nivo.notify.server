...
After successfully setup, the `bootstrap.sql` will be passed to mysql so thats a handy place to put a database dump in. Anyway, since this is optional you simply can remove this file.
