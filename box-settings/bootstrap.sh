...
# install php 7 stack
#
sudo apt-get install -y php7.0-fpm php7.0 php7.0-mysql php7.0-curl php7.0-gd php7.0-intl php-pear php7.0-imap php7.0-mcrypt php7.0-sqlite3 snmp php7.0-mbstring &&
